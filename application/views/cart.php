							...
							<table class="cart-summary table table-bordered">
								...
								<tbody>
									<tr>
										...
										<td>
											<a href="product-detail-left-sidebar.html">
												<img width="80" alt="Product Image" class="img-responsive" src="assets/img/product/hp.jpg">
											</a>
										</td>
										<td>
									...
									<tr>
										...
										<td>
											<a href="product-detail-left-sidebar.html">
												<img width="80" alt="Product Image" class="img-responsive" src="assets/img/product/komputer.jpg">
											</a>
										</td>
										<td>
											<a href="product-detail-left-sidebar.html" class="product-name">Ini komputer</a>
										</td>
										<td class="text-center">
											$150
										</td>
